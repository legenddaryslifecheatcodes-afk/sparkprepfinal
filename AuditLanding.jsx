        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-24 grid md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <div className="marketing-surface p-6" data-testid="audit-form">
              <div className="font-mono-spec text-[10px] tracking-widest uppercase text-neutral-500 mb-4">[ Step 01 · Set target ]</div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label className="font-mono-spec text-[10px] tracking-widest uppercase text-neutral-500">Trim size {detectedSpec?.trim_width?.value && <span className="text-emerald-500 normal-case">(overridden by your template below)</span>}</Label>
              ...
              <div className="font-mono-spec text-[10px] tracking-widest uppercase text-neutral-500 mt-6 mb-3">[ Step 02 · Optional: upload your publisher's template ]</div>
              <p className="text-xs text-neutral-500 mb-3">Have the blank template PDF your distributor gave you (trim/bleed/spine guide)? Upload it and we'll read the real, current specs straight out of it instead of using the preset above.</p>
              ...
              <div className="font-mono-spec text-[10px] tracking-widest uppercase text-neutral-500 mt-6 mb-3">[ Step 03 · Drop your cover or interior file ]</div>
